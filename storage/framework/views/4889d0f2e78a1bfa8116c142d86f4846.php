...
<?php endif; ?>
        ...
        <a href="<?php echo e(route('auth.google')); ?>" class="inline-block px-6 py-2 text-white bg-black rounded-lg shadow-md">Login with Google</a>
        <!-- <a href="<?php echo e(route('auth.facebook')); ?>" class="inline-block px-6 py-2 text-white bg-blue-600 rounded-lg shadow-md">Login with Facebook</a> -->
...
<?php endif; ?>
<?php /**PATH C:\Users\nafis\OneDrive\Desktop\your-project-name\resources\views/auth/login.blade.php ENDPATH**/ ?>