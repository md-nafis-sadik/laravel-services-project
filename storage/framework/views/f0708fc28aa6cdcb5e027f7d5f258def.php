...
<head>
    ...
    <title>Payment for <?php echo e($plan->name); ?></title>
...
<div class="container mx-auto px-8 py-16">
    <div class="bg-white p-6 rounded-lg shadow-md max-w-xl mx-auto">
        <form action="<?php echo e(route('packages.store', $plan->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-6">
                ...
                <p id="amount" class="font-semibold text-xl text-gray-900">$ <?php echo e($plan->price); ?></p>
            </div>
...
<?php /**PATH C:\Users\nafis\OneDrive\Desktop\your-project-name\resources\views/packages/payment.blade.php ENDPATH**/ ?>