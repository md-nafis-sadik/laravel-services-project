...
<head>
    ...
    <title><?php echo e($plan->name); ?> Details</title>
    ...
    <div class="max-w-full mx-auto p-12 md:px-32 py-10">
        <div class=" block md:flex justify-between">
            ...
            <div class="text-lg text-gray-700 mb-4">
                <p><strong>Name:</strong> <?php echo e($plan->name); ?></p>

                <p><strong>Duration:</strong> <?php echo e($plan->duration); ?> days</p>
            </div>

            <div class="text-md text-gray-600 mb-6">
                <p><strong>Description:</strong></p>
                <?php $__currentLoopData = $plan->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-3"><?php echo html_entity_decode($feature->description); ?></div>
...
<p class="text-white"><?php echo e($plan->name); ?></p>
</div>
<div class="text-md font-semibold py-2 border-b mb-6">Payment Details</div>

<span class="text-3xl text-center mb-4">1 item</span>
<div class="flex justify-between w-full py-2 text-sm"><span>Total</span> <span> $<?php echo e($plan->price); ?></span></div>
<div class="flex justify-between w-full py-2 mb-4 text-sm"><span>Discount</span> <span> $0 </span></div>
<div class="flex justify-between w-full py-4 border-t"><span class="text-lg">Total</span> <span class="text-2xl"> $<?php echo e($plan->price); ?></span></div>

                <a href="<?php echo e(route('packages.payment', $plan->id)); ?>" class="inline-block px-6 py-3 text-md font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-sm shadow-md transition duration-300">
                    Proceed to Payment
                </a>
            </div>
        </div>
...
<?php /**PATH C:\Users\nafis\OneDrive\Desktop\your-project-name\resources\views/packages/details.blade.php ENDPATH**/ ?>